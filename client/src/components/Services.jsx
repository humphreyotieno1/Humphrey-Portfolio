  ...
  return (
    <section className="mt-12 mx-auto px-4 max-w-screen-xl md:px-8 font-sans" id='services'>
      ...
      <div className="flex justify-center mt-8">
        <a href="#contact" className="inline-flex items-center justify-center h-12 gap-2 px-6 text-sm font-medium tracking-wide text-white transition duration-300 rounded-full whitespace-nowrap bg-black dark:bg-gray-600 dark:hover:bg-gray-700 hover:bg-blue-600 focus:bg-cyan-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-cyan-300 disabled:bg-cyan-300 disabled:shadow-none">
          <span>Contact</span>
